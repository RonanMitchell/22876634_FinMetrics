...
### Plain ole rebalancing portfolio.
...
RandRebalance <- RandRebalance %>% 
    ...
    select(date, RollSD, RollSDHedged) 
...
RandRebalance %>%
  ggplot(aes(x = date)) +
  geom_line(aes(y = RollSD), color = "blue4", size = 1) +
  geom_line(aes(y = RollSDHedged), color = "red4", size = 1) +
