...
\caption{Caption Here \label{Figure5.1}}\label{fig:unnamed-chunk-3}
\end{figure}
...
\caption{Caption Here \label{Figure5.2}}\label{fig:unnamed-chunk-4}
\end{figure}

\begin{figure}[H]

{\centering \includegraphics{Question-5_files/figure-latex/unnamed-chunk-5-1} 

}

\caption{Caption Here \label{Figure5.3}}\label{fig:unnamed-chunk-5}
\end{figure}
